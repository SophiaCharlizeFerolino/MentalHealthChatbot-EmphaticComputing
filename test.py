...
intents = {
    ...
    'joy':['good','great','relieved','happy','okay'],
    'anger': ['angry', 'mad', 'outraged', 'furious', 'enraged', 'irritated', 'annoyed', 'frustrated'],
    'love': ['love', 'affection', 'adoration', 'passion', 'devotion', 'infatuation', 'admiration', 'care'],
    'surprised': ['surprised', 'amazed', 'astonished', 'shocked', 'startled', 'bewildered', 'dumbfounded'],
    'fear': ['fear', 'fright', 'terror', 'panic', 'dread', 'anxiety', 'apprehension', 'worry'],
    'sadness': ['sadness', 'sorrow', 'grief', 'heartache', 'melancholy', 'unhappiness', 'tears', 'despondency', 'despair', 'mourning']
}
...
data = pd.read_csv("emotion.csv", header=0, delimiter=",", quoting=2, index_col=False)
